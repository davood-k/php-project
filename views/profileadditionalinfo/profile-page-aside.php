                        ...
                        <div class="profile-box">
                            <div class="profile-box-header">
                                <div class="profile-box-avatar">
                                    <img src="public/img/svg/user.svg" alt="">
                                </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <ul class="profile-avatars default text-center">
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/user.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-1.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-2.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-3.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-4.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-5.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-6.svg"></img>
                                                    </li>
                                                    <li>
                                                        <img class="profile-avatars-item" src="public/img/svg/avatar-7.svg"></img>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
