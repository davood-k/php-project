    ...
    <div class="col-12">
        <div class="widget widget-product card">
            <header class="card-header">
                <img src="public/img/amazing-slider/amazing-title-01.png" width="150px" alt="">
                <a href=http://ehsanghasimi.ir/ class="view-all">مشاهده همه</a>
            </header>
            <div class="product-carousel owl-carousel owl-theme">
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/60eb20-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/4ff777-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/35a2b8-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/9b3da9-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/c8297f-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/a579bb-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
                ...
                <div class="item">
                    <a href=http://ehsanghasimi.ir/>
                        <img src="public/img/product-slider/19a2cc-200x200.jpg"
                             class="img-fluid" alt="">
                    </a>
                    <h2 class="post-title">
            ...
            <div class="col-6 col-lg-3">
                <div class="widget-banner card">
                    <a href=http://ehsanghasimi.ir/ target="_blank">
                        <img class="img-fluid" src="public/img/banner/banner-1.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="widget-banner card">
                    <a href=http://ehsanghasimi.ir/ target="_top">
                        <img class="img-fluid" src="public/img/banner/banner-2.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="widget-banner card">
                    <a href=http://ehsanghasimi.ir/ target="_top">
                        <img class="img-fluid" src="public/img/banner/banner-3.jpg" alt="">
                    </a>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="widget-banner card">
                    <a href=http://ehsanghasimi.ir/ target="_top">
                        <img class="img-fluid" src="public/img/banner/banner-4.jpg" alt="">
                    </a>
                </div>
            </div>
        </div>
